...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-07-2020 a las 03:12:14
...
INSERT INTO `empresas` (`id`, `nombre`, `direccion`, `telefono`, `ciudad`, `id_admin`, `active`, `created_at`, `updated_at`) VALUES
(2, 'MKT Soluciones', 'cra 52A #1A-22', '322222222', '2', 3, 1, '2020-07-16 04:16:59', '2020-07-09 07:12:42'),
(3, 'Bosques de Cañaveralejo', 'Calle 1 #52-52', '333444555', '2', 3, 1, '2020-07-16 04:17:04', '2020-07-09 07:12:52'),
(4, 'Guadalajara', 'cll13 #15-55', '333555777', '2', 5, 1, '2020-07-16 04:17:09', '2020-07-09 07:22:10'),
(5, 'Visitamos', 'cll 10 #12', '2223334445', '1009', 8, 1, '2020-07-17 03:27:52', '2020-07-17 08:27:52'),
(6, 'Caramanta III', 'calle 1A #53B', '55555555', '2', 1, 1, '2020-07-16 04:17:21', '2020-07-09 07:22:54'),
(7, 'Eficacia SA', 'Av 6aN #34N-22', '333111555777', '2', 5, 1, '2020-07-16 04:17:27', '2020-07-09 07:14:17'),
(8, 'Accion Plus', 'Av 9N #23-22', '333225566', '2', 8, 1, '2020-07-16 04:17:33', '2020-07-11 20:11:21'),
(9, 'sdfghf', 'sdfh5 sdf5', '45656+6', '1130', 8, 1, '2020-07-17 08:24:06', '2020-07-17 08:24:06');
...
CREATE TABLE `items` (
  ...
  `borrar_campo` bigint(20) UNSIGNED DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `items` (`id`, `nomenclatura`, `descripcion`, `codigo`, `empresa_id`, `marca_id`, `id_admin`, `borrar_campo`, `created_at`, `updated_at`) VALUES
(1, 'Queso original 200g', 'queso de almendras untable de 200g', '1111111111', 3, 14, 3, 6, '2020-07-18 02:03:01', '2020-07-18 07:03:01'),
(2, 'Base de Almendras 200 g', 'Base de almendras para 4 litros', '132654789', 3, 14, 3, 7, '2020-07-25 00:19:57', '2020-07-25 05:19:57'),
(3, 'Toping de Cacao y avellanas', '200g sin azucar añadido ni conservantes', '45678987654', 2, 14, 3, NULL, '2020-07-25 00:18:04', '2020-07-25 05:18:04');
...
INSERT INTO `marcas` (`id`, `nombre`, `ciudad`, `direccion`, `telefono`, `contacto`, `info`, `empresa_id`, `updated_at`, `created_at`) VALUES
(2, 'Krima', 1, 'call x', '334545', 'juan', 'asdgfa', 2, '2020-07-19 03:54:41', '2019-08-19 20:35:33'),
(3, 'CocaCola', 1, 'call xr', '135345', 'pepe', 'asddfgfg', 2, '2020-07-19 03:53:50', '2019-08-19 20:35:39'),
(4, 'Colgate', 1, 'call xc', '12345135', 'ana', 'adfgadfg', 2, '2020-07-19 03:53:52', '2019-08-19 20:35:47'),
(5, 'Cafe X', 1, 'call xr', '234534', 'luis', 'rtertqert', 3, '2020-07-19 03:55:17', '2019-08-19 20:36:14'),
(6, 'Fruco', 1, 'call x33', '23455', 'edi', 'qertqert', 3, '2020-07-19 03:55:29', '2019-08-19 20:36:29'),
(7, 'Pepsi', 1, 'call x55', '234564', 'luis a', 'qertqertqer', 3, '2020-07-19 03:55:35', '2019-08-19 20:36:37'),
(8, 'Jet', 1, 'call x123', '234564', 'manu', 'dsfgsdfgsdf', 4, '2020-07-19 03:55:41', '2019-08-20 01:39:34'),
(9, 'Great', 1, 'call x678', '23454', 'maari', 'zbcvzcxvxc', 4, '2020-07-19 03:55:50', '2019-08-20 01:40:04'),
(10, 'Fres Campo', 1, 'cra1', '367356', 'rosa', 'werqwer', 4, '2020-07-19 03:56:04', '2019-08-20 01:40:15'),
(11, 'Color Cacao', 1, 'cra2', '7653756', 'bob', 'zxcvxcv', 2, '2020-07-19 03:54:19', '2019-08-21 01:30:02'),
(14, 'Alves', 1, 'cra3', '435633', 'jhon', 'ueutyu', 2, '2020-07-19 03:54:31', '2019-08-23 19:47:02');
...
(1130, 11, 1, 'BOGOTÁ (DISTRITO CAPITAL)');
...
INSERT INTO `pdvs` (`id`, `nombre`, `ciudad`, `direccion`, `telefono`, `contacto`, `info`, `empresa_id`, `latitud`, `longitud`, `created_at`, `updated_at`) VALUES
(1, 'Vitafitness Sexta', 1009, 'Av 6N #29-32', '30012345678', 'Karla Londoño', 'pdv vitafitness principal. Mayor rotación', 2, -76.321655, 34.756985, '2020-07-19 02:41:36', '2020-07-19 07:41:36'),
(2, 'Vitafitness Pasoancho', 1009, 'calle13 #80-99', '3001472356', 'Mauren Cardona', 'Vitafitness con la segunda rotación mas alta', 2, 74.698540, 34.698521, '2020-07-19 07:02:49', '2020-07-19 07:02:49');
...
INSERT INTO `users` (`id`, `name`, `last_name`, `email`, `dni`, `telefono`, `email_verified_at`, `password`, `active`, `tipo_usuario`, `empresa_id`, `admin_id`, `ciudad`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Santiago', 'Lopera Montoya', 'santiagoloperam@gmail.com', '123456', '300300300', NULL, '$2y$10$e242xA5eSr6mXH0R6lRa0.8HEpTMBaANv9pVw4NiPXoELwyvYRHDa', 1, 1, 2, 3, '1', 'vXK6NrROuLh4o2Gcs9hK6mkFzdhBmR94NxHzbZutMjfp4M5kTinbxVnYQMdR', '2019-08-01 00:41:57', '2019-08-14 10:18:31'),
(3, 'Edward', 'Gordillo', 'edmadx25@gmail.com', '6666666', '312312312', NULL, '$2y$10$wrrpa56T6PhRvWZGcU3sAO6KwWp0pn/TBe2CTY5nMjqdkuxZSaCt2', 1, 2, 2, 3, '1', 'A2l1rbXa7WE6ic33LbIiNgZMPiWWdH8ztGYl1AvLB367jmM8bdtH1EF3JdG5', '2019-08-07 06:05:15', '2019-08-12 22:35:48'),
(5, 'Walter', 'Paz Londoño', 'walter.paz.00@gmail.com', '44444444', '322322322', NULL, '$2y$10$9h74ck8r9HDNw2eBdLexBuu2UMFdWkMa5ed4S0sNTa7TN9y1ID5oi', 1, 3, 2, 3, '1130', NULL, '2019-08-08 04:09:01', '2020-07-17 05:53:15'),
(6, 'Carlos', 'Lopez', 'carlos@gmail.com', '123456', '3456688', NULL, '$2y$10$w5QxOd0pAQVfrNTRlq3EseUwGtpvmWNca87L5QjiuMnYX6figPue2', 1, 3, 3, 2, '1', NULL, NULL, '2019-09-07 02:41:21'),
(7, 'Rulos', 'Paz', 'rulospaz@gmail.com', '4567899', '4567899', NULL, '$2y$10$9q1PrkMCqY.19Drn2lZaWeujiYDna3ZicAkiPLFpHaVMbfty.v9GW', 1, 4, 7, 2, '5', NULL, '2019-09-07 02:10:23', '2020-07-17 05:47:45'),
(8, 'Luis Miguel', 'Paz Gordillo', 'luismiguelpaz96@gmail.com', '19961996', '3333333333', NULL, '$2y$10$afbc0rSZKTZyVJyizTtu/u1H0/NzBqZeJPsZMWDPVtnpqAzdDhLx2', 1, 1, 8, 2, '271', NULL, NULL, '2020-07-17 05:50:28'),
(9, 'jorge', 'Diaz', 'jdiaz96@gmail.com', '1990', '3652147', NULL, '1990', 1, 2, 2, 2, '1', NULL, NULL, NULL),
(13, 'Pepe Alejandro', 'Perez Perez', 'nuevo_pperez@gmail.com', '1975', '2223344', NULL, '$2y$10$z3JCbA5vtxaBVjAE7md2Oe.uTu4uhY1tYcNWsdicy9qqu4dRE3ERy', 1, 3, 2, 2, '1', NULL, NULL, '2020-07-12 06:08:08'),
(15, 'Nancy', 'MKT', 'mktsoluciones@gmail.com', '123456789', '123456789', NULL, '$2y$10$c7lsaACX37iSuJdcDg.6pOj/qvQvRD9BozZx/OsIl.9mTCon5XcxS', 1, 3, 2, 3, '1130', NULL, '2020-07-13 03:41:22', '2020-07-19 09:07:00'),
(16, 'borrame', 'rapido', 'borrar@gmail.com', '546464', '546889', NULL, '$2y$10$/2q9eFWJgm/EL6Znx6LHtOroHt6LN5Fe1UkInAX7yfT1FcoJNN952', 1, 3, 2, NULL, '1130', NULL, '2020-07-17 05:38:40', '2020-07-17 05:38:40');
...
CREATE TABLE `visitas` (
  ...
  `pdv_id` int(10) UNSIGNED NOT NULL,
  `marca_id` int(10) UNSIGNED NOT NULL,
  `user_asignado` bigint(20) UNSIGNED NOT NULL,
  `url_foto` varchar(255) DEFAULT NULL,
  `time_foto` date DEFAULT NULL,
...
INSERT INTO `visitas` (`id`, `fecha_prog`, `pdv_id`, `marca_id`, `user_asignado`, `url_foto`, `time_foto`, `latitud`, `longitud`, `estado`, `created_at`, `updated_at`) VALUES
(1, '2020-07-22', 1, 14, 15, '', '0000-00-00', 0.000000, 0.000000, 1, '2020-07-20 15:41:34', '0000-00-00 00:00:00'),
(2, '2020-08-01', 1, 14, 6, NULL, NULL, 0.000000, 0.000000, 2, '2020-07-29 04:32:02', '2020-07-29 09:32:02'),
(3, '2020-07-31', 1, 3, 15, NULL, NULL, NULL, NULL, 1, '2020-07-22 08:27:05', '2020-07-22 08:27:05'),
(4, '2020-08-08', 1, 3, 15, NULL, NULL, NULL, NULL, 1, '2020-07-23 09:15:15', '2020-07-23 09:15:15'),
(6, '2020-07-31', 2, 4, 5, NULL, NULL, NULL, NULL, 1, '2020-07-25 03:27:18', '2020-07-25 03:27:18'),
(16, '2020-08-05', 1, 14, 5, NULL, NULL, NULL, NULL, 1, '2020-07-26 23:26:53', '2020-07-27 04:26:53');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `visitas_items`
--

CREATE TABLE `visitas_items` (
  `id` bigint(20) NOT NULL,
  ...
  `fecha_vencimiento_min` date DEFAULT NULL,
  `fecha_vencimiento_max` date DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `visitas_items`
--

INSERT INTO `visitas_items` (`id`, `visita_id`, `marca_id`, `pdv_id`, `user_asignado`, `item_id`, `cantidad`, `fecha_vencimiento_min`, `fecha_vencimiento_max`, `nota`, `created_at`, `updated_at`) VALUES
(1, 15, 14, 2, 15, 1, NULL, NULL, NULL, NULL, '2020-07-25 04:54:02', '2020-07-25 04:54:02'),
(2, 16, 14, 1, 5, 1, NULL, NULL, NULL, NULL, '2020-07-25 05:20:30', '2020-07-25 05:20:30'),
(3, 16, 14, 1, 5, 2, NULL, NULL, NULL, NULL, '2020-07-25 05:20:31', '2020-07-25 05:20:31'),
(4, 16, 14, 1, 5, 3, NULL, NULL, NULL, NULL, '2020-07-25 05:20:31', '2020-07-25 05:20:31');
...
ALTER TABLE `items`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_unidad` (`empresa_id`),
  ADD KEY `id_bloque` (`marca_id`),
  ADD KEY `id_propietario` (`id_admin`),
  ADD KEY `id_arrendatario` (`borrar_campo`);
...
--
-- Indices de la tabla `visitas_items`
--
ALTER TABLE `visitas_items`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `municipios`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1131;

--
-- AUTO_INCREMENT de la tabla `pdvs`
--
ALTER TABLE `pdvs`
...
--
-- AUTO_INCREMENT de la tabla `visitas_items`
--
ALTER TABLE `visitas_items`
...
--
ALTER TABLE `empresas`
  ADD CONSTRAINT `empresas_ibfk_1` FOREIGN KEY (`id_admin`) REFERENCES `users` (`id`);

--
-- Filtros para la tabla `items`
--
ALTER TABLE `items`
  ADD CONSTRAINT `items_ibfk_1` FOREIGN KEY (`empresa_id`) REFERENCES `empresas` (`id`),
  ADD CONSTRAINT `items_ibfk_2` FOREIGN KEY (`marca_id`) REFERENCES `marcas` (`id`),
  ADD CONSTRAINT `items_ibfk_3` FOREIGN KEY (`id_admin`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `items_ibfk_4` FOREIGN KEY (`borrar_campo`) REFERENCES `users` (`id`);

--
-- Filtros para la tabla `marcas`
--
ALTER TABLE `marcas`
  ADD CONSTRAINT `marcas_ibfk_1` FOREIGN KEY (`empresa_id`) REFERENCES `empresas` (`id`);
...
--
ALTER TABLE `tipo_aptos`
  ADD CONSTRAINT `tipo_aptos_ibfk_1` FOREIGN KEY (`id_unidad`) REFERENCES `empresas` (`id`);
